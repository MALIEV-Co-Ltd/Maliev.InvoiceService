...
/// <summary>
/// Validator for UpdateInvoiceRequest with optimistic concurrency control.
/// </summary>
public class UpdateInvoiceRequestValidator : AbstractValidator<UpdateInvoiceRequest>
{
    ...
    public UpdateInvoiceRequestValidator()
    {
        ...
        RuleFor(x => x.RowVersion)
            .NotEmpty().WithMessage("Row version is required for optimistic concurrency control")
            .Must(rv => rv.Length > 0).WithMessage("Row version must not be empty");
    }
